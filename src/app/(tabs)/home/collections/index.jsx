import { View, TouchableOpacity, FlatList, TextInput, Modal, ToastAndroid, StatusBar } from "react-native";
...
const collections = () => {
    ...
    const getSalesInvoiceDetails = ({ _id, invoiceNo = "" }) => {
        ...
        if (_id) salesInvoice = realm.objectForPrimaryKey("salesInvoices", _id);
            ...
            salesInvoice = realm
                ...
                .find((s) => s.invoiceNo.toUpperCase() === invoiceNo.toUpperCase());
    ...
    const renderShowModalInvocie = () => {
        return (
            <Modal animationType="fade" transparent={false} visible={showInvoiceModal}>
                <View className="flex justify-center items-center h-full bg-slate-300">
                    <View className="shadow-md drop-shadow-sm rounded-md ring-1 w-11/12 p-5 bg-white">
                        <View className="relative">
                            ...
                            />
                            <TouchableOpacity
                                className="absolute inset-y-0 right-0 flex items-center justify-center pr-10"
                                onPress={() => {
            ...
            <View className="items-center justify-center m-2">
                ...
                <FlatList
                    ...
                    renderItem={({ item }) => (
                        <CollectionCard
                            data={item}
                            onEdt={() => router.push({ pathname: ROUTES.SALES_INVOICE_DETAILS, params: item })}
                            enableButtons={false}
                            onSelect={() => {
