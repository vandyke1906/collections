            ...
            <View className="mt-5 p-2">
                ...
                <View className="mt-2 mb-5 flex border-t border-gray-300">
                    <View className="flex flex-row items-center justify-between">
                        <Text className="mx-2 block font-sans text-xs antialiased leading-normal text-gray-500 uppercase">
                            Customers
                        </Text>
                        <TouchableOpacity
                            onPress={() => {
                        ...
                        >
                            <Text className="pointer-events-auto inline-block cursor-pointer rounded text-xs font-bold leading-normal text-blue-700 uppercase m-2">
                                Select Customer
                            </Text>
                        </TouchableOpacity>
                    </View>
                        ...
                        {customers.map((item, index) => (
                            <MiniCardData key={index} parentClass={miniCardClass}>
                                <View className="flex flex-row">
                                    <Text className="block font-sans text-xs antialiased leading-normal text-gray-500 uppercase">
                                        {item.name}
                                    </Text>
                                    <TouchableOpacity
                                        className="ml-2"
                    ...
                    <View className="flex flex-row items-center justify-between">
                        ...
                        <TouchableOpacity
                            onPress={() => {
                                ...
                                router.push({
                                    pathname: ROUTES.SALES_INVOICE_SELECTION,
                                    params: { multipleSelect: 1 },
                                });
                            }}
                        >
                            <Text className="pointer-events-auto inline-block cursor-pointer rounded text-xs font-bold leading-normal text-blue-700 uppercase m-2">
