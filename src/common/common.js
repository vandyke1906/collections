...
export const ROUTES = {
    ...
    CUSTOMER_VIEW: "/(tabs)/customers/customerView",
    CUSTOMER_REPORT: "/(tabs)/customers/customerReport",
    PRODUCTS: "/(tabs)/products",
    PRODUCT_FORM: "/(tabs)/products/productForm",
    PRODUCT_VIEW: "/(tabs)/products/productView",
    PRODUCT_REPORT: "/(tabs)/products/productReport",
    USERS: "/(tabs)/users",
